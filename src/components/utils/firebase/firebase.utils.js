...
export const addCollectionAndDocuments = async (
  ...
  //attach a bunch of different write,deletes,set, we can add this all to the batch and only when we re ready to fire off the batch does the actual transation begin
